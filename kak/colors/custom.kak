#
# Custom theme adapted from Nightowl theme
#
# Adapted from: https://github.com/sdras/night-owl-vscode-theme/

# Custom colors
declare-option str red "rgb:ff6961"
declare-option str orange "rgb:f69552"
declare-option str yellow "rgb:ffd347"
declare-option str puke "rgb:b2cc00"
declare-option str green "rgb:4fd377"
declare-option str mint "rgb:1cc38c"
declare-option str cyan "rgb:00bbd4"
declare-option str blue "rgb:448aff"
declare-option str indigo "rgb:5a7ad3"
declare-option str purple "rgb:966fd6"
...
declare-option str gray "rgb:9e9e9e"
declare-option str blue_gray "rgb:607d8b"
...
set-face global ts_punctuation_bracket       "%opt{indigo}"
