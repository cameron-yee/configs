...
evaluate-commands %sh{
    ...
    echo "
        # code
        face global value              ${nord6}
        face global type               ${nord13}
        face global variable           ${nord6}
        face global module             ${nord6}
        face global function           ${nord9}
        face global string             ${nord12}
        face global keyword            ${nord10}
        face global operator           ${nord9}
        face global attribute          ${nord15}
        face global comment            ${nord3}
        face global meta               ${nord7}
        face global builtin            ${nord7}+b
        ...
        # builtin
        face global Default            ${nord8},default
        ...
        face global LineNumbers        ${nord3},default
